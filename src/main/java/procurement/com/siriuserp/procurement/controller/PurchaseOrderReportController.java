...
public class PurchaseOrderReportController extends ControllerBase
{
	...
	@RequestMapping("/purchaseordertaxreportpre.htm")
	public ModelAndView pre() throws ServiceException
	{
		return new ModelAndView("/report/purchase/purchaseOrderTaxReportAdd", service.pre());
	}

	@RequestMapping("/purchaseordertaxreportview.htm")
	public ModelAndView view(HttpServletRequest request) throws Exception
	{
		return new ModelAndView("/report/purchase/purchaseOrderTaxReportList", service.viewTax(criteriaFactory.createReport(request, PurchaseReportFilterCriteria.class)));
	}
}

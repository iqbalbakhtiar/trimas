/**
 * File Name  : PurchaseOrderViewQuery.java
...
public class PurchaseOrderViewQuery extends AbstractGridViewQuery
{
	@Override
	public Query getQuery(ExecutorType executorType)
	{
		...
		builder.append("WHERE purchase.purchaseType IS NOT NULL ");

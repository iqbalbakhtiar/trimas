...
@Controller
@SessionAttributes(value = "billing_batch_form", types = ReceivablesForm.class)
...
public class BillingBatchController extends ControllerBase
{
	...
	public ModelAndView add(@ModelAttribute("billing_batch_form") ReceivablesForm form, BindingResult result, SessionStatus status) throws Exception
	{
	...
	public ModelAndView edit(@ModelAttribute("billing_batch_form") ReceivablesForm form, SessionStatus status) throws Exception
	{
		JSONResponse response = new JSONResponse();

/**
 * Dec 4, 2008 11:15:04 AM
 * com.siriuserp.reporting.accounting.controller
 * PostClosingTrialBalanceController.java
 */
...
@DefaultRedirect(url = "prepostingtrialbalancereportpre.htm")
public class PrePostingTrialBalanceController extends ControllerBase
{
	@Autowired
	...
	@RequestMapping("/prepostingtrialbalancereportpre.htm")
	public ModelAndView pre()
	{
		return new ModelAndView("/report/accounting/prePostingTrialBalanceReportAdd", trialBalanceService.pre());
	}

	@RequestMapping("/prepostingtrialbalancereportview.htm")
	...
	{
		return new ModelAndView("/report/accounting/prePostingTrialBalanceReportList", trialBalanceService.viewprepost(criteria));
	}
}

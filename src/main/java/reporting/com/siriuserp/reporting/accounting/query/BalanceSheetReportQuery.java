...
public class BalanceSheetReportQuery extends AbstractAccountingReportQuery
{
	public List execute()
	{
		...
		builder.append("FROM JournalEntryDetail detail WHERE detail.journalEntry.entrySourceType != 'CLOSING' AND detail.journalEntry.entryStatus = 'POSTED' ");

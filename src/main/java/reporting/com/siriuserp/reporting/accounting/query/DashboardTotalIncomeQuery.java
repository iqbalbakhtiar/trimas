...
public class DashboardTotalIncomeQuery extends AbstractStandardReportQuery 
{
	...
	public DashboardTotalIncomeQuery(Long organization, int period, List<Party> subsidiaries, Long parent) 
	{
		super();
	...
	{	
		List<NetIncomeDashboardReportAdapter> list = getIncome();
		
		return list;
	}
	
	private List<NetIncomeDashboardReportAdapter> getIncome()
	{
		...
		builder.append("AND acb.account.accountType.id = 4 ");

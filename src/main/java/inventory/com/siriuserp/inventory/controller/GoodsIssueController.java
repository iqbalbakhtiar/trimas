...
@Controller
@SessionAttributes(value = "transaction_form", types = TransactionForm.class)
...
public class GoodsIssueController extends ControllerBase {
    ...
    public ModelAndView edit(@ModelAttribute("transaction_form")TransactionForm form, SessionStatus status) throws Exception {

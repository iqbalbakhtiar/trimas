...
@Controller
@SessionAttributes(value = { "goodsReceipt_add", "goodsReceipt_edit", "adapter" }, types = {GoodsReceipt.class, WarehouseItemAdapter.class, TransactionForm.class})
...
public class GoodsReceiptController extends ControllerBase {
    ...
    {
        return new ModelAndView("/inventory/goods-receipt/goodsReceiptList",
                service.view(criteriaFactory.create(request, GoodsReceiptFilterCriteria.class), GoodsReceiptGridViewQuery.class));
    }

    @RequestMapping("/goodsreceiptpreadd1.htm")
    public ModelAndView preadd1(HttpServletRequest request) throws Exception
    {
        return new ModelAndView("/inventory/goods-receipt/goodsReceiptPreadd1",
                service.preadd1(criteriaFactory.create(request, GoodsReceiptFilterCriteria.class), ReceiptableGridViewQuery.class));
    }
	...
	public ModelAndView add(@ModelAttribute("goodsReceipt_add")TransactionForm form, SessionStatus status) throws Exception {
	...
	public ModelAndView edit(@ModelAttribute("adapter")TransactionForm form, SessionStatus status) throws Exception {
		JSONResponse response = new JSONResponse();

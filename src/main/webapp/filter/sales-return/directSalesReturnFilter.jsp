<div dojoType="FloatingPane" id="filter" title="Filter" constrainToContainer="true" style="width: 30%; height: 300px; left: 400px; display:none;" toggle="explode" bg>
	<form id="filterForm" name="filterForm" method="post">
		...
		<tr>
			...
			<td width="4">:&nbsp;</td>
			<td width="411" height="28"><input type="text" id="customerName" name="customerName" value="${filterCriteria.customerName}" size="30" class="inputbox"/></td>
		</tr>
		<tr>
			<td align="right"><spring:message code="directsalesorder"/>&nbsp;</td>
			<td width="4">:&nbsp;</td>
			<td width="411" height="28"><input type="text" id="salesOrderCode" name="salesOrderCode" value="${filterCriteria.salesOrderCode}" size="30" class="inputbox"/></td>
		</tr>
		<tr>
...
<script type="text/javascript">
	function searchs()
	{
		var url = "<c:url value='/page/directsalesreturnview.htm?mode=search'/>";
	...
	function resets()
	{
		window.location = "<c:url value='/page/directsalesreturnview.htm'/>";
	}
	...
	function step(action)
	{
		...
		document.filterForm.action = "<c:url value='/page/directsalesreturnview.htm?page='/>"+page;
		document.filterForm.submit();
	}
</script>
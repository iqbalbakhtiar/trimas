<div dojoType="FloatingPane" id="filter" title="Filter" constrainToContainer="true" style="width: 50%; height: 230px; left: 260px; display:none;" toggle="explode" bg>
	<form id="filterForm" name="filterForm" method="post">
		...
		<tr>
			...
			<td>:</td>
			<td width="304" height="28"><input type="text" id="lotCode" name="lotCode" value="${filterCriteria.lotCode}" size="10"/></td>
		</tr>

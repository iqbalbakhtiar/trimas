<div dojoType="FloatingPane" id="create" title='<spring:message code="goodsissue"/>' constrainToContainer="true" style="width: 30%; height: 100px; left: 300px; display:none;" toggle="explode" bg>
		...
		const confirmDialog = $('<div><spring:message code="notif.rejournal"/> ?</div>').dialog(
		{
			...
			buttons: {
				'<spring:message code="sirius.yes"/>': function() {
					...
					var url = "<c:url value='/page/goodsissuerecalculatejournal.htm'/>";

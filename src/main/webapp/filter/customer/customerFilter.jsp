<div dojoType="FloatingPane" id="filter" title="Filter" constrainToContainer="true" style="width: 25%; height: 250px; left: 300px; display:none;" toggle="explode" bg>
	...
	<tr>
		...
		<td width="4">:&nbsp;</td>
		<td width="310" height="28"><input type="text" id="company" name="company" class="inputbox" value="<c:out value='${filterCriteria.company}'/>"/></td>
	</tr>
	<tr>
		...
		<td>
			<select id="active" name="active">
			    <option value="" ${filterCriteria.active == null ? "selected" : ""}>
			        <spring:message code="sirius.all"/>
			    </option>
			    <option value="true" ${filterCriteria.active != null && filterCriteria.active ? "selected" : ""}>
			        <spring:message code="sirius.active"/>
			    </option>
			    <option value="false" ${filterCriteria.active != null && !filterCriteria.active ? "selected" : ""}>
	...
	<tr>
		...
		<td>
			<select id="base" name="base">
			    <option value="" ${filterCriteria.base == null ? "selected" : ""}>
			        <spring:message code="sirius.all"/>
			    </option>
			    <option value="true" ${filterCriteria.base != null && filterCriteria.base ? "selected" : ""}>
			        <spring:message code="sirius.group"/>
			    </option>
			    <option value="false" ${filterCriteria.base != null && !filterCriteria.base ? "selected" : ""}>

<div dojoType="FloatingPane" id="filter" title="Filter" constrainToContainer="true" style="width: 35%; height: 350px; left: 300px; display:none;" toggle="explode" bg>
	<form id="filterForm" name="filterForm" method="post">
	<table width="100%" cellspacing="0" cellpadding="0" align="right">
	<tr>
		<td align="right" style="WIDTH:180px;"><spring:message code="sirius.code"/>&nbsp;&nbsp;</td>
		<td width="4">:&nbsp;</td>
	...
	<tr>
		<td align="right" style="WIDTH:180px;"><spring:message code="supplier"/>&nbsp;&nbsp;</td>
		<td width="4">:&nbsp;</td>
	...
	<tr>
		<td align="right" style="WIDTH:180px;"><spring:message code="sirius.tax"/>&nbsp;&nbsp;</td>
		<td width="4">:&nbsp;</td>
		<td width="310" height="28"><input type="text" id="tax" name="tax" class="inputbox" value="<c:out value='${filterCriteria.tax}'/>"/></td>
	</tr>
	<tr>
		<td align="right"><spring:message code="approval.status"/>&nbsp;</td>
		<td >:</td>
		<td >
	...
	<tr>
		<td align="right" style="WIDTH:180px;"><spring:message code="approver"/>&nbsp;&nbsp;</td>
		<td width="4">:&nbsp;</td>
	...
	<tr>
		<td align="right" style="WIDTH:180px;"><spring:message code="dpo.billto"/>&nbsp;&nbsp;</td>
		<td width="4">:&nbsp;</td>
	...
	<tr>
		<td align="right" style="WIDTH:180px;"><spring:message code="dpo.shipto"/>&nbsp;&nbsp;</td>
		<td width="4">:&nbsp;</td>

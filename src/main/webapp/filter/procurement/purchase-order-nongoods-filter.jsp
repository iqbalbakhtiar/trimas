<script type="text/javascript">
	function searchs()
	{
		var url = "<c:url value='/page/purchaseordernongoodsview.htm'/>";
	...
	function step(action)
	{
		...
		document.filterForm.action = "<c:url value='/page/purchaseordernongoodsview.htm?page='/>"+page;
		document.filterForm.submit();
	}
	...
	function openrequisitioner()
	{
		...
		openpopup("<c:url value='/page/purchaseordernongoodsview.htm?target=requisitioner&organization='/>"+org.value);
	}
</script>
<div dojoType="FloatingPane" id="filter" title="Filter" constrainToContainer="true" style="width: 48%; height: 250px; left: 350px; display:none;" toggle="explode">
	<form id="filterForm" name="filterForm" method="post">
        ...
        <tr>
		 ...
		 <tr>
			<td align="right">Item Alias&nbsp;&nbsp;</td>
			<td width="4">:&nbsp;</td>
			<td>
            	<input type="text" name="itemAlias" value="${filterCriteria.itemAlias}"/>
            </td>
		</tr>
		 <tr>
			...
			<td width="4">:&nbsp;</td>
			<td>
            	<input type="text" name="notes" value="${filterCriteria.notes}"/>
            </td>
		</tr>
		<tr>

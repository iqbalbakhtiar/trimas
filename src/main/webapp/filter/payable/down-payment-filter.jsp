<script type="text/javascript">
	function searchs()
	{
		var url = "<c:url value='/page/downpaymentview.htm'/>";
	...
	function resets()
	{
		window.location = "<c:url value='/page/downpaymentview.htm'/>";
	}
	...
	function step(action)
	{
		...
		document.filterForm.action = "<c:url value='/page/downpaymentview.htm?page='/>"+page;
		document.filterForm.submit();
	}
</script>
<div dojoType="FloatingPane" id="filter" title="Filter" constrainToContainer="true" style="width: 48%; height: 275px; left: 350px; display:none;" toggle="explode" bg>
	<form id="filterForm" name="filterForm" method="post">
		<input type="hidden" value="DOWN_PAYMENT" name="methodType"/>
        ...
        <tr>
			...
			<td>:&nbsp;</td>
			<td><input type="text" id="supplier" name="supplier" value="${filterCriteria.supplier}" size="35" class="inputbox"/></td>
		</tr>
		 <tr>
			<td align="right">Legend&nbsp;&nbsp;</td>
			<td>:&nbsp;</td>
			<td><input type="text" id="itemAlias" name="itemAlias" value="${filterCriteria.itemAlias}" size="35" class="inputbox"/></td>
		</tr>
		<tr>

      ...
      <tr>
        ...
        <td >
          <select id="status" name="status">
            ...
            <option value="PAID" ${not empty filterCriteria.status and filterCriteria.status eq 'PAID' ? "selected" : ""}><spring:message code="sirius.paid"/></option>
            <option value="UNPAID" ${not empty filterCriteria.status and filterCriteria.status eq 'UNPAID' ? "selected" : ""}><spring:message code="sirius.unpaid"/></option>
          </select>
        </td>
      </tr>

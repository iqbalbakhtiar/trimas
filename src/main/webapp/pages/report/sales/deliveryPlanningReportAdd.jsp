					...
					<div id="se-contents">
                    	...
                    	<div class="main-box">
							<sesform:form name="reportForm" id="reportForm" method="post" modelAttribute="reportCriteria">
								...
								<tr>
                                    <td><div align="right"><spring:message code="customer"/> :</div></td>
                                    <td>
...
<script type="text/javascript">
	$(function()
	{
		$('.item-button-generate-report').click(function()
		{
			...
			document.reportForm.action = "<c:url value='/page/deliveryplanningreportview.htm'/>";
	...
	function resetform()
	{
		window.location = "<c:url value='/page/deliveryplanningreportpre.htm'/>";
	}

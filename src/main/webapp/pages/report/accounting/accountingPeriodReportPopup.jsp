					...
					<div id="se-contents">
							...
							<td>
								<form id="filterPopup" name="filterPopup" method="post">
									<table width="100%" cellspacing="0" cellpadding="0" align="center">
										<tr>
											<td align="right" nowrap="nowrap"><spring:message code="accountingperiod.code"/> / <spring:message code="accountingperiod.name"/>&nbsp;&nbsp;</td>
											<td width="7">:&nbsp;</td>
											<td height="28" align="left"><input type="text" id="name" name="name" value="${filterCriteria.name}" size="35"/></td>
											<td align="left" nowrap="nowrap"><%@ include file="/common/button.jsp"%></td>
										</tr>
									</table>
								</form>
							</td>
						...
						<table class="table-list" cellspacing="0" cellpadding="0" width="80%">
					  	<tr>
					  		...
					  		<th width="20%"><spring:message code="accountingperiod.code"/></th>
				  		  	<th width="79%"><spring:message code="accountingperiod.name"/></th>
				  		</tr>
						<c:forEach items="${periods}" var="com">
						<tr>
					  		<td class="tools">

	...
	<script type="text/javascript">
		function setclient(id,name,code,type)
		{
			if(id && name) {
				...
				var _code = self.opener.document.getElementById('code[${param.index}]');
				if(_code)
					_code.value = code;
					...
					<div id="se-contents">
						...
						<table class="table-list" cellspacing="0" cellpadding="0" width="80%">
							...
							<c:forEach items="${costCenters}" var="data">
								<tr>
									<td class="tools">
										<a class="item-button-add-row" href="javascript:setclient('${data.id}','${data.name}','${data.code}','${data.type}')"  title="Edit"><span><spring:message code="sirius.edit"/></span></a>
									</td>

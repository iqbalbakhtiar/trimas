<%@ include file="/common/tld-common.jsp"%>				
    ...
    <c:forEach items='${reports}' var='report'>
  	   <c:if test="${report.sum > 0 || report.opening > 0 || report.in > 0 || report.out > 0}">
  	      ...
  	      <tr>
  	          <th width="10%" align="left"><spring:message code="productcategory"/></th>
  	        	<th align="left" >&nbsp;:&nbsp;<c:out value='${report.productCategory}'/></th>
  	        	<th align="left">&nbsp;</th>
  	        	<th>&nbsp;</th>
  	        	<th align="left">&nbsp;</th>
  	      </tr>
      ...
      <tr style="height: 30px;">
          	<th width="5%" align="left" style="border-left:solid 1px #000000;border-bottom:solid 1px #000000;border-right:solid 1px #000000;"><spring:message code="sirius.date"/></th>
	  	  	<th width="10%" align="left" style="border-bottom:solid 1px #000000;border-right:solid 1px #000000;" ><spring:message code="sirius.description"/></th>
  			<th width="15%" align="left" style="border-bottom:solid 1px #000000;border-right:solid 1px #000000;"><spring:message code="goodsreceipt.refdoc"/></th>
 	  		<!-- <th width="40%" align="left" style="border-bottom:solid 1px #000000;border-right:solid 1px #000000;"><spring:message code="sirius.note"/></th> -->
  	  		<th width="15%" style="border-bottom:solid 1px #000000;border-right:solid 1px #000000;"  align="center"><spring:message code="sirius.in"/></th>
	  	  	<th width="15%" style="border-bottom:solid 1px #000000;border-right:solid 1px #000000;"  align="center"><spring:message code="sirius.out"/></th>
     	  	<th width="15%" style="border-bottom:solid 1px #000000;border-right:solid 1px #000000;"  align="center"><spring:message code="sirius.qty"/></th>
      ...
      <tr>
          ...
          <td style="border-bottom:solid 1px #000000;border-right:solid 1px #000000;" align="right">
       		<fmt:formatNumber value='${trx.in}' pattern=',##0.00'/>
          	<c:if test="${criteria.showBale}">
          		<strong>(<fmt:formatNumber value='${trx.inBale}' pattern=',##0.00'/> BALE)</strong>
          	</c:if>
          </td>
          <td style="border-bottom:solid 1px #000000;border-right:solid 1px #000000;" align="right">
       		<fmt:formatNumber value='${trx.out}' pattern=',##0.00'/>
          	<c:if test="${criteria.showBale}">
          		<strong>(<fmt:formatNumber value='${trx.outBale}' pattern=',##0.00'/> BALE)</strong>
          	</c:if>
          </td>
          <td style="border-bottom:solid 1px #000000;border-right:solid 1px #000000;" align="right">
       		<fmt:formatNumber value='${trx.sum}' pattern=',##0.00'/>
          	<c:if test="${criteria.showBale}">
          		<strong>(<fmt:formatNumber value='${trx.sumBale}' pattern=',##0.00'/> BALE)</strong>
          	</c:if>
          </td>
          <%-- <c:if test="${criteria.showBale}">
        ...
        <tr>
          ...
          <td style="border-bottom:solid 1px #000000;border-right:solid 1px #000000;" colspan='2'><spring:message code="accreport.closing"/></td>
          <td style="border-bottom:solid 1px #000000;border-right:solid 1px #000000;" align="right">
       		<fmt:formatNumber value='${report.in}' pattern=',##0.00'/>
          	<c:if test="${criteria.showBale}">
          		<strong>(<fmt:formatNumber value='${report.inBale}' pattern=',##0.00'/> BALE)</strong>
      		</c:if>
          </td>
          <td style="border-bottom:solid 1px #000000;border-right:solid 1px #000000;" align="right">
       		<fmt:formatNumber value='${report.out}' pattern=',##0.00'/>
          	<c:if test="${criteria.showBale}">
          		<strong>(<fmt:formatNumber value='${report.outBale}' pattern=',##0.00'/> BALE)</strong>
       		</c:if>
          </td>
          <td style="border-bottom:solid 1px #000000;border-right:solid 1px #000000;" align="right">
       		<fmt:formatNumber value='${report.sum}' pattern=',##0.00'/>
          	<c:if test="${criteria.showBale}">
          		<strong>(<fmt:formatNumber value='${report.sumBale}' pattern=',##0.00'/> BALE)</strong>
          	</c:if>
          </td>
          <%-- <c:if test="${criteria.showBale}">
      ...
      <tr>
          <%-- <td colspan="${criteria.showBale ? 9 : 6}">&nbsp;</td> --%>
          <td colspan="6">&nbsp;</td>
      </tr>
      </tbody>
      <tfoot>
      <tr style="font-weight: bold;height: 30px;">
          <td align="right" colspan='3' style="border-bottom:solid 1px black;">&nbsp;</td>
          ...
          <td align="right" style="border-bottom:solid 1px black;">
       		<fmt:formatNumber value='${report.sum}' pattern=',##0.00'/>
          	<c:if test="${criteria.showBale}">
          		(<fmt:formatNumber value='${report.sumBale}' pattern=',##0.00'/> BALE)
       		</c:if>
          </td>
          <%-- <c:if test="${criteria.showBale}">
	          <td align="right" style="border-bottom:solid 1px black;">&nbsp;</td>

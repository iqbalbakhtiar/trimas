					  	...
					  	<div class="main-box">
					  		...
					  		<table border="0" cellpadding="5" cellspacing="0" width="100%" align="center">
					  			<tr style="height: 30px;">
					  				...
					  				<th style="border-top:1px solid black;border-bottom:1px solid black;border-left:1px solid black;width: 20%"><spring:message code="sirius.unitprice"/></th>
								...
								<c:forEach items="${adapter.items}" var="item" varStatus="idx">
					  			...
					  			<tr style="height: 50px;word-spacing: 1.5px;">
                               		<c:set var="pattern" value=",##0.00" />
					  				<td style="border-bottom:1px solid black;border-left:1px solid black;">
					  					<strong>${item.product.name}</strong>
					  					<c:if test="${not empty item.note}"></br><div style="margin-top: 5px;">(${item.note})</div></c:if>
					  				</td>
				  					...
				  					<ul>
				  						...
				  						<li><spring:message code="salesorder.contract.payment"/>
					  						...
					  						<tr style="font-weight: bold;">
					  							...
					  							<td>
					  							PT SHUN HUI ZHIYE INDONESIA</br>
					  							OCBC NISP</br>
					  							ASIA AFRIKA - BANDUNG</br>
					  							<strong style="font-size: 11px;">0000000000</strong>
					  							</td>
					  							...
					  							ASIA AFRIKA - BANDUNG</br>
					  							<strong style="font-size: 11px;">000000000</strong>
					  							</td>
				  							</tr>
				  							</table>
				  						</li>

...
<head>
	...
	<%@ include file="/filter/sales/salesOrderFilter.jsp"%>
</head>
<body>
			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
							...
							<tr>
								...
								<div class="toolbar-clean">
									<c:if test='${access.add}'>
										<a class="item-button-new" href="<c:url value='/page/salesorderpreadd.htm' />"><span><spring:message code="salesorder.new"/></span></a>
							   		</c:if>
						...
						<tr>
							<td class="tools">
								<a class="item-button-edit" href="<c:url value='/page/salesorderpreedit.htm?id=${sales.id}'/>" title="<spring:message code='sirius.edit'/>"><span><spring:message code="sirius.edit"/></span></a>
							</td>

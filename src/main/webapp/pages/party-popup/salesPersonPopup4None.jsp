					...
					<div id="se-contents">
						...
						<table class="table-list" cellspacing="0" cellpadding="0" width="80%">
					  	<tr>
					  		...
					  		<th width="20%"><spring:message code="party.code"/></th>
				  		  	<th width="79%"><spring:message code="party.name"/></th>
				  		</tr>

					...
					<div id="se-contents">
						...
						<tr>
							<td>
								<form id="filterPopup" name="filterPopup" method="post">
									...
									<tr>
										<td width="25%" align="right"><spring:message code="salesapprover.code"/> :</td>
						...
						<table class="table-list" cellspacing="0" cellpadding="0" width="80%">
					  	<tr>
					  		...
					  		<th width="20%"><spring:message code="salesapprover.code"/></th>
				  		  	<th width="79%"><spring:message code="salesapprover.name"/></th>
				  		</tr>

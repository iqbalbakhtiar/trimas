			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
						...
						<div class="main-box">
							<sesform:form id="addForm" name="addForm" method="post" modelAttribute="role_add">
								...
								<tr>
                                    ...
                                    <td>
                                        <form:select id="org" path="organization" cssClass="combobox-ext">
                                            <option value="${role_add.organization.id}"><c:out value='${role_add.organization.fullName}'/></option>
                                        </form:select>
							...
							<br/>
                                <div id="detail" dojoType="TabContainer" style="width:100% ; height: 250px;">
                                    <div id="sourceItem" dojoType="ContentPane" label="<spring:message code='grid.source'/>" class="tab-pages" refreshOnShow="true">
			                            ...
			                            <thead>
			                            <tr>
			                              	<th width="2%"><input id ="check" value="srcs" class="checkall" type="checkbox"/></th>
                                    ...
                                    <div id="destinationItem" dojoType="ContentPane" label="<spring:message code='grid.destination'/>" class="tab-pages" refreshOnShow="true">
			                            ...
			                            <thead>
			                            <tr>
			                              	<th width="2%"><input id ="check" value="dests" class="checkall" type="checkbox"/></th>
...
<script type="text/javascript">
	$(function(){
		...
		$('.item-button-save').click(function(){
			...
			{
				$.ajax({
					url:"<c:url value='/page/gridroleadd.htm'/>",

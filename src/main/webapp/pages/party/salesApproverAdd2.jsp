			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">						
						...
						<div class="main-box">
							<sesform:form id="addForm" name="addForm" method="post" modelAttribute="salesApprover_add" enctype="multipart/form-data">
								<c:set var="newPerson" value=""/>
								<c:if test="${!salesApprover_add.newPerson}">
                                ...
                                <tr>
                                    ...
                                    <td>
										...
										<c:if test='${not empty salesApprover_add.organization}'>
											<form:option value='${salesApprover_add.organization.id}' label='${salesApprover_add.organization.firstName}'/>
										</c:if>
                                        </form:select>
 								...
 								<tr>
 									<td align="right"><spring:message code="salesapprover.code"/></td>
									...
									<td>
										...
										<c:if test="${!salesApprover_add.newPerson}">
											<input value="${salesApprover_add.code}" disabled class="input-disabled"/>
										</c:if>
									</td>
                                ...
                                <tr>
									...
									<td>
										...
										<c:if test="${!salesApprover_add.newPerson}">
											<input value="${salesApprover_add.salutation}" size='5' disabled class="input-disabled"/>
										</c:if>
									</td>
 								...
 								<tr>
									...
									<td>
										...
										<c:if test="${!salesApprover_add.newPerson}">
											<input id='firstName' value="${salesApprover_add.fullName}" size='36' disabled class="input-disabled"/>
										</c:if>
									</td>
...
<script type="text/javascript">
	$(function(){
		...
		$('.item-button-save').click(function(){
			if(!$first.val())
			{
				alert('<spring:message code="salesapprover.name"/> <spring:message code="notif.empty"/> !!!');
				return;
			}

					...
					<div id="se-contents">
						...
						<div class="main-box">
							...
							<table width="100%" style="border:none">
								...
								<tr>
									<td align="right"><spring:message code="salesperson.new"/> :</td>
									<td>
                                ...
                                <tr>
									...
									<td>
										<form:select id="person" path="id" cssClass="combobox-ext">
										</form:select>
										<a class="item-popup" onclick="openPerson('person');"  title="Person" />
									</td>
								</tr>
							</table>
							</sesform:form>
...
<script type="text/javascript">
  	function save()
	{
		if(!$('#org').val())
		{
			alert('<spring:message code="notif.select1"/> <spring:message code="salesperson.organization"/> <spring:message code="notif.select2"/> !!!');
			return;
		}
	    ...
	    document.addForm.action = "<c:url value='/page/salespersonpreadd2.htm'/>";
	...
	function openPerson(target)
	{
		...
		openpopup("<c:url value='/page/popupsalespersonview.htm?target="+target+"&organization='/>"+org.value+"&notSalesPerson=true");
	}
</script>

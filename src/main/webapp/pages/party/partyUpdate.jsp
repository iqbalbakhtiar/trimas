			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
									...
									<div id="address" dojoType="ContentPane" label="<spring:message code="postaladdress"/>" class="tab-pages">
										...
										<tr>
											<td class="tools">
												...
												<a class="item-button-delete" href="javascript:showDialog('<c:url value='/page/postaladdressdelete.htm?id=${postal.id}&party=${postal.party.id}'/>');" title="Del"><span><spring:message code="sirius.delete"/></span></a>
											</td>
										...
										<tr>
											<td class="tools">
												...
												<a class="item-button-delete" href="javascript:showDialog('<c:url value='/page/contactmechanismdelete.htm?id=${contact.id}&party=${contact.party.id}'/>');" title="Del"><span><spring:message code="sirius.delete"/></span></a>
											</td>
										...
										<tr>
											<td class="tools">
												<c:if test='${relAccess.delete}'>
													<a class="item-button-delete" href="javascript:showDialog('<c:url value='/page/partyrelationshipdelete.htm?id=${relation.id}'/>');" title="Del"><span><spring:message code="sirius.delete"/></span></a>
												</c:if>
											</td>
						...
						<div class="info"><spring:message code="sirius.createdby"/> : <c:out value='${party_edit.createdBy.fullName}'/> (<fmt:formatDate value='${party_edit.createdDate}' pattern='dd-MM-yyyy HH:mm:ss'/>) | <spring:message code="sirius.updatedby"/> : <c:out value='${party_edit.updatedBy.fullName}'/> (<fmt:formatDate value='${party_edit.updatedDate}' pattern='dd-MM-yyyy HH:mm:ss'/>)</div>
					</div>
				</div>
			</div>
		</div>

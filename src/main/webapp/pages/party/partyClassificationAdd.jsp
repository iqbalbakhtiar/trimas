...
<html>
<head>
	<title>Party Classification >> Add</title>
	...
	<script type="text/javascript">
		function save()
		{
			document.addForm.action = "<c:url value='/page/partyclassificationadd.htm'/>";
...
<div id="se-containers">
	...
	<div id="se-navigator">
		...
		<tr>
			<td width="60%">Company Administration > Party > Party Classification > Add</td>
		...
		<div id="r12">
			<div id="r13">
				<div id="r14">
					...
					<div class="main-box">
						<sesform:form name="addForm" method="post" modelAttribute="partyClassification" cssClass="edit-form">
						<table>

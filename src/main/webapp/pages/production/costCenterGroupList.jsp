					...
					<div id="se-contents">
							...
							<tr>
								...
								<div class="toolbar-clean">
									<c:if test='${access.add}'>
										<a class="item-button-new" href="<c:url value='/page/costcentergrouppreadd.htm' />"><span><spring:message code="costcenter.new"/></span></a>
							   		</c:if>
						...
						<tr>
							<th width="3%">&nbsp;</th>
					  	  	...
					  	  	<th width="5%"><spring:message code="sirius.uom"/></th>
						...
						<tr>
							 <td class="tools">
							 	<c:if test='${access.edit}'>
							        <a class="item-button-edit" href="<c:url value='/page/costcentergrouppreedit.htm?id=${data.id}'/>" title="<spring:message code='sirius.edit'/>">
							            <span><spring:message code="sirius.edit"/></span>
							        </a>
								</c:if>
								<c:if test='${access.delete}'>
									<a class="item-button-delete" href="javascript:showDialog('<c:url value='/page/costcentergroupdelete.htm?id=${data.id}'/>');" title="<spring:message code='sirius.delete'/>"><span><spring:message code="sirius.delete"/></span></a>
								</c:if>
							</td>

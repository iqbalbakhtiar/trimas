...
<head>
    ...
    <%@ include file="/filter/accounting/journalEntryFilter.jsp"%>
</head>
<body>
								...
								<td width="30%" height="30" align="left" valign="middle">															
									<div class="toolbar-clean">
										<c:if test='${access.add}'>
											<a class="item-button-new" href="<c:url value='/page/journalentrypreadd.htm'/>"><span><spring:message code="journalentry.new"/></span></a>
										</c:if>
						...
						<tr>
							<td class="tools">
								...
								<c:if test="${journal.entryStatus != 'POSTED' and access.delete and journal.entrySourceType == 'STANDARD'}">
									<a class="item-button-delete" href="javascript:showDialog('<c:url value='/page/journalentrydelete.htm?id=${journal.id}'/>','<spring:message code="notif.delete"/>');"><span>Del</span></a>
								</c:if>
							</td>
							<td nowrap="nowrap"><c:out value="${journal.code}"/></td>

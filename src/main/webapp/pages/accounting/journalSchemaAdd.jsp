			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
						...
						<div class="main-box">
							<sesform:form name="addForm" method="post" modelAttribute="journalSchema_add">
							<table style="border:none" width="100%">
							<tr>
								<td width="20%" align="right"><spring:message code="journalschema.code"/></td>
							  	<td width="1%">:</td>
						  	  	<td width="40%"><form:input id="code" path="code" cssClass="inputbox" /></td>
							...
							<tr>
								...
								<td width="1%">:</td>
						  	  <td width="40%"><form:input id="name" path="name" cssClass="inputbox" /></td>
		    				</tr>
							<tr>
							...
							<tr>
								...
								<td width="1%">:</td>
									...
									<a class="item-popup" onclick="javascript:openpopup('<c:url value='/page/popupchartofaccountview.htm?target=coa'/>');"  title="Company Structure" />
								</td>
							</tr>
							<tr>
							...
							<div id="container" dojoType="TabContainer" style="width:100% ; height: 250px;">
								<div id="debet" dojoType="ContentPane" label="<spring:message code="journalschema.debet"/>" class="tab-pages">
									<div class="toolbar-clean">
										...
										<a class="item-button-new" href="javascript:addLineItem('DEBET','debet');"><span><spring:message code="journalschema.newrow"/></span></a>
										<a class="item-button-delete" href="javascript:deleteRow('lineItemTable-debet')"><span><spring:message code="journalschema.deleterow"/></span></a>
			 						</div>
                                    ...
                                    <tr>
										<th width="1%">&nbsp;</th>
									 	<th width="1%" align="left"><input type="checkbox" name="checkMaster" id="checkMaster-lineItemTable-debet" onClick="clickAll('lineItemTable-debet');"/></th>
									  	<th width="15%" colspan="2"><spring:message code="glaccount"/></th>
...
<script type="text/javascript">
	function save()
	{
		...
		if(!$('#org').val())
		{
			alert('<spring:message code="notif.select1"/> <spring:message code="journalschema.organization"/> <spring:message code="notif.select2"/> !!!');
			return;
		}
		...
		document.addForm.action = "<c:url value='/page/standardjournalschemaadd.htm'/>";
		document.addForm.submit();
	}

	function savenew()
	{
		document.addForm.action = "<c:url value='/page/standardjournalschemaaddnew.htm'/>";
		document.addForm.submit();
	}

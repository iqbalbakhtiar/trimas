			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
						...
						<div class="main-box">
							<sesform:form cssClass="edit-form" id="editForm" name="editForm" method="post" modelAttribute="bankAccount_form">
			 				<table width="100%" style="border:none" class="space">
							<tr>
								<td width="29%" align="right"><spring:message code="bankaccount.code"/> :</td>
					 		  	<td width="70%"><form:input path="code" maxlength="30" cssClass="inputbox input-disabled" disabled='true'/></td>
							</tr>
							<tr>
								<td align="right"><spring:message code="bankaccount.bankname"/> :</td>
								<td><form:input path="bankName" maxlength="50" cssClass="inputbox input-disabled" disabled='true'/></td>
							</tr>
                            <tr>
								<td align="right"><spring:message code="bankaccount.branch"/> :</td>
								<td><form:input path="bankBranch" maxlength="50" cssClass="inputbox input-disabled" disabled='true'/></td>
							</tr>
							<tr>
								<td align="right"><spring:message code="bankaccount.accountname"/> :</td>
								<td><form:input path="accountName" maxlength="50" cssClass="inputbox input-disabled" disabled='true'/></td>
							</tr>
                            <tr>
								<td width="29%" align="right"><spring:message code="bankaccount.accountno"/> :</td>
				  				<td width="70%"><form:input path="accountNo" maxlength="50" cssClass="inputbox input-disabled" disabled='true'/></td>
							</tr>
                            <tr>
								<td width="29%" align="right"><spring:message code="bankaccount.type"/> :</td>
				  				<td width="70%">
                                	<form:select path='accountType' disabled='true' class="input-disabled">
                            ...
                            <tr>
                                ...
                                <td>
                                    <select id="coa" class="combobox-ext input-disabled" disabled>
                                        <c:if test='${not empty bankAccount_edit.chartOfAccount}'>
                                            <option value='${bankAccount_edit.chartOfAccount.id}'><c:out value='${bankAccount_edit.chartOfAccount.code} ${bankAccount_edit.chartOfAccount.name}'/></option>
                                        </c:if>
                                    </select>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
									<form:select id="account" path="account" cssClass="combobox-ext">
                                    	<form:option value='${bankAccount_edit.account.id}' label='${bankAccount_edit.account.code} ${bankAccount_edit.account.name}'/>
									</form:select>
                            ...
                            <tr>
                                ...
                                <td>
									<form:select id="chargeAccount" path="chargeAccount" cssClass="combobox-ext">
                                    	<form:option value='${bankAccount_edit.chargeAccount.id}' label='${bankAccount_edit.chargeAccount.code} ${bankAccount_edit.chargeAccount.name}'/>
									</form:select>
                            ...
                            <tr>
                                ...
                                <td>
                                	<form:select id="org" path="holder" cssClass="combobox-ext input-disabled" disabled="true">
										<form:option value='${bankAccount_form.holder.id}' label='${bankAccount_form.holder.fullName}' />
									</form:select>
                                </td>
							</tr>
                            <tr>
						...
						<div class="info"><spring:message code="sirius.createdby"/> : <c:out value='${bankAccount_edit.createdBy.fullName}'/> (<fmt:formatDate value='${bankAccount_edit.createdDate}' pattern='dd-MM-yyyy HH:mm:ss'/>) | <spring:message code="sirius.updatedby"/> : <c:out value='${bankAccount_edit.updatedBy.fullName}'/> (<fmt:formatDate value='${bankAccount_edit.updatedDate}' pattern='dd-MM-yyyy HH:mm:ss'/>)</div>
					</div>
				</div>
			</div>
		</div>
...
<script type="text/javascript">
	$(function()
	{
		...
		{
			$.ajax({
				url:"<c:url value='/page/bankaccountedit.htm'/>",

			...
			<td width="48%" colspan="3" valign="top">
				<table width="100%" cellpadding="0" cellspacing="0" align="left">
					<tr>
						...
						<td width="84%">
							<c:out value='${billing_form.customer.salutation} ${billing_form.customer.fullName}'/><br/>
							<c:out value="${billing_form.shippingAddress.addressName}"/><br/>
							<c:out value="${billing_form.shippingAddress.address}"/><br/>
							<c:out value="${billing_form.shippingAddress.city.name}"/> - <c:out value="${billing_form.shippingAddress.postalCode}"/><br/>
						</td>
					</tr>
				</table>
			</td>
				...
				<table width="100%"  border="0" cellpadding="0" cellspacing="0">
					...
					<c:forEach items='${billing_form.billing.items}' var='item' varStatus='status'>
						<tr>
							...
							<td align="left" width="30%" nowrap="nowrap">&nbsp;${item.billingReferenceItem.product.name}</td>
					...
					<tfoot>
						<tr>
							...
							<td class="border-top" align="right" style="padding-right:5px;"><fmt:formatNumber value='${billing_edit.totalLineItemAmountForPrint}' pattern=',##0.00'/></td>
						</tr>
					</tfoot>
				</table>
			</td>
...
<%--						Pembatas--%>
					...
					<tr>
						<td align="right">(</td>
						<td align="center">
							<c:out value='${billing_form.organization.salutation} ${billing_form.organization.fullName}'/>
						</td>
						<td align="left">)</td>
						<td>&nbsp;</td>
						<td align="right">(</td>

...
<html>
	<head>
	<title>Accounting Period >> Popup</title>
								...
								<form id="filterPopup" name="filterPopup" method="post">
									<table width="100%" cellspacing="0" cellpadding="0" align="center">
										<tr>
											...
											<td align="left"><input type="button" value="Search" style="WIDTH:60px; HEIGHT:25px" alt="Search" onclick="search('<c:url value='/page/popupaccountingperiodview.htm?target=${target}&openonly=${filterCriteria.openonly}&organization=${filterCriteria.organization}&mode=search'/>');" class="btn" /></td>
										</tr>
									</table>
								</form>
							</td>

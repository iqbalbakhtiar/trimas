								...
								<td width="96%" colspan="3" valign="top">
									<table width="100%" cellpadding="3" cellspacing="0" align="left">
										<tr>
											...
											<td width="30%">
												<strong><c:out value="${billing_batch_edit.code}"/></strong>
											</td>
										</tr>
										<tr>
											<td width="10%"><strong>Sudah Terima dari</strong></td>
											<td width="1%"><strong>:</strong></td>
											<td width="30%"><strong><c:out value='${billing_batch_edit.customer.fullName}'/></strong></td>
										</tr>
										...
										<tr>
											...
											<td width="30%" class="border-top border-bottom border-left border-right" style="padding: 0.5rem;">
												<c:out value='${saidId}'/> <c:out value="${defaultCurrency.alias}"/>
											</td>
										</tr>
										<tr><td colspan="3" style="height: 10px;">&nbsp;</td></tr>
										...
										<tr>
											...
											<td width="1%" style="vertical-align: top;"><strong>:</strong></td>
											<td width="30%" style="vertical-align: top;"><strong><c:out value='${references}'/></strong></td>
										</tr>
									</table>
								</td>
								<td width="2%" colspan="2">&nbsp;</td>
								...
								<td width="48%" colspan="3" valign="top">
									<table width="100%" cellpadding="0" cellspacing="0" align="left">
										...
										<tr class="border-top border-bottom">
											<td class="border-top border-bottom" width="10%"><strong>Jumlah ${defaultCurrency.symbol}</strong></td>
											<td class="border-top border-bottom" width="30%" align="right"><strong><fmt:formatNumber value="${billing_batch_edit.amount}" pattern=",##0.00"/>&nbsp;&nbsp;&nbsp;</strong></td>
										</tr>
									</table>
								</td>
								<td width="48%" colspan="3" valign="top">
									<table width="100%" cellpadding="0" cellspacing="0" align="left">
										...
										<tr>
											<td align="center">
												<strong>
													Sumedang, <fmt:formatDate value='${billing_batch_edit.date}' pattern='dd MMMM yyyy'/>
												</strong>
											</td>
										</tr>

				...
				<div id="r14">
					<div id="se-contents">
						...
						<h1 class="page-title">${pageTitle}</h1>
					  	...
					  	<div class="toolbar">
							<a class="item-button-list" href="<c:url value='/page/accountingschemapreedit.htm?id=${resource_schema_add.accountingSchema.id}'/>"><span><spring:message code="sirius.list"/></span></a>
						...
						<div class="main-box">
							<sesform:form id="addForm" name="addForm" method="post" modelAttribute="resource_schema_add">

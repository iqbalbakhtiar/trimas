					...
					<div id="se-contents">
						...
						<div class="main-box">
							<sesform:form id="addForm" name="addForm" method="post" modelAttribute="categorySchema">
                                ...
                                <tr>
									<td width="30%" align="right" nowrap="nowrap"><spring:message code="accountingschema"/> :</td>
							  		<td width="69%">
								...
								<tr>
									...
									<td>
										<form:select id="category" path="category" cssClass="combobox-ext input-disabled" disabled='true'>
...
<script type="text/javascript">
	function save()
	{		
		document.addForm.action = "<c:url value='/page/productcategoryaccountingschemaedit.htm'/>";

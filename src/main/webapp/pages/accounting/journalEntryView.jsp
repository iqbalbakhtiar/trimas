						...
						<div class="main-box">
							...
							<tr valign="top">
								<td width="50%">
                                    ...
                                    <tr>
										...
										<td>
                                            ...
                                            <select class="input-disabled">
                                            	<option><c:out value='${journalEntry_edit.exchangeType}'/></option>
											</select>
                                            <input size="9" value="<fmt:formatNumber value='${journalEntry_edit.rate}' groupingUsed='true' maxFractionDigits='0'/>" disabled class="input-disabled"/>
										</td>
									</tr>
                                    <tr>
								...
								<tr>
                                	<th width="10%"><spring:message code="journaldetail.code"/></th>
						  	  		<th width="12%"><spring:message code="journaldetail.account"/></th>
					  	  	  		...
					  	  	  		<th width="8%"><spring:message code="journaldetail.amount"/>&nbsp;(Rp)</th>
								...
								<tr>
                                    ...
                                    <td><fmt:formatNumber value='${detail.amount}' pattern=',##0.000'/></td>
                                    <td><fmt:formatNumber value='${detail.amount * journalEntry_edit.rate}' pattern=',##0.000'/></td>

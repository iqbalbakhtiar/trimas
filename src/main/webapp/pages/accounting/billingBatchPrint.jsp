...
<div class="toolbar">
	<a class="item-button-back" href="<c:url value='/page/billingbatchpreedit.htm?id=${billing_batch_form.id}'/>"><span><spring:message code="sirius.back"/></span></a>
	...
	<div class="main_container">
		<center>
			...
			<table border="0" width="100%" cellpadding="0" cellspacing="0">
				...
				<tr class="body-print">
					<td width="2%" colspan="2">&nbsp;</td>
					<td width="96%" colspan="6" align="left">${billing_batch_form.billingBatch.customer.salutation} <c:out value="${billing_batch_form.billingBatch.customer.fullName}"/></td>
					<td width="2%" colspan="2">&nbsp;</td>
				</tr>
				<tr class="body-print">
					<td width="2%" colspan="2">&nbsp;</td>
					<td width="96%" colspan="6" align="left">
						<c:out value="${customerAddress.address}"/>
						<c:out value="${customerAddress.city.name}"/>
						<c:out value="${customerAddress.province.name}"/>
						<c:out value="${customerAddress.postalCode}"/>
					</td>
					<td width="2%" colspan="2">&nbsp;</td>
				</tr>
				<tr class="body-print">
				...
				<tr class="body-print">
					<td width="2%" colspan="2">&nbsp;</td>
					<td width="2%">&nbsp;</td>
					<td width="96%" colspan="6" align="left">1. Kwitansi Asli Senilai ${defaultCurrency.symbol} <fmt:formatNumber value="${billing_batch_form.amount}" pattern="#,##0.00"/></td>
					<td width="2%" colspan="2">&nbsp;</td>
				</tr>
				<tr class="body-print">
					<td width="2%" colspan="2">&nbsp;</td>
				...
				<tr class="body-print">
					...
					<td width="2%">&nbsp;</td>
					<td width="96%" colspan="6" align="left">
						3. Faktur Penjualan No.
						<c:forEach var="it" items="${billing_batch_form.billingBatch.items}" varStatus="vs">
							<c:out value="${it.billing.code}"/><c:if test="${!vs.last}">, </c:if>
						</c:forEach>
					</td>
					<td width="2%" colspan="2">&nbsp;</td>
				</tr>
						...
						<table width="100%" cellpadding="0" cellspacing="0" align="left">
							...
							<tr>
								<td align="left">
									...
									<fmt:formatDate value='${billing_batch_form.date}' pattern='dd MMMM yyyy'/>
								</td>
							</tr>

<%@ include file="/common/sirius-general-top.jsp"%>					  	<div class="toolbar">
						...
						<div class="main-box">
							<sesform:form id="addForm" name="addForm" method="post" modelAttribute="employee_add" enctype="multipart/form-data">
 								<table style="border:none" width="100%">
								<tr>
 									<td align="right"><spring:message code="organization"/> :</td>
									<td>
										<form:select id="org" path="organization" cssClass="combobox-ext">
									    <c:if test='${not empty employee_add.organization}'>
											<form:option value='${employee_add.organization.id}' label='${employee_add.organization.fullName}'/>
									    </c:if>
										</form:select>
                                ...
                                <tr>
 								...
 								<tr>
									...
									<td><form:input id="name" path="firstName" cssClass="inputbox"/></td>
	 							</tr>
	 							<tr>
...
$(function(){
	$('.item-button-save').click(function()
	{
		if(validation())
		{
			...
			xhr.open('POST', "<c:url value='/page/employeeadd.htm'/>");
			...
			xhr.onreadystatechange = function () {
				if(xhr.readyState == 4)
				{
					...
					if(json)
					{
						...
						{
							$dialog.dialog('close');
							window.location="<c:url value='/page/employeepreedit.htm?id='/>"+json.data.id;
						}
						else

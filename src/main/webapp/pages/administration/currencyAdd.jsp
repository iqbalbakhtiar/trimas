					...
					<div id="se-contents">
						...
						<div class="main-box">
							<c:if test="${not empty message}">
 							...
 							<sesform:form cssClass="edit-form" id="currencyForm" name="currencyForm" modelAttribute="currency_add" method="post">
 							<table width="752" border="0" cellpadding="0" cellspacing="0">
 							<tr>
 								<td width="128"><div class="form-label"><spring:message code='sirius.id'/> :</div></td>
 							...
 							<tr>
 								<td width="128"><div class="form-label">&nbsp;</div></td>
							  	<td width="192"><input type="checkbox" name="base"><spring:message code='sirius.default'/></input></td>
						  	  <td><form:errors path="name" cssClass="error"/></td>
 							</tr>
 							</table>
							</sesform:form>

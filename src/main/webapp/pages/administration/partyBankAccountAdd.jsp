<%@ include file="/common/sirius-general-top.jsp"%>	
					...
					<div class="main-box">
						<sesform:form id='addForm' name="addForm" method="post" modelAttribute="partyBankAccount_add">
						<table style="border:none" width="100%">
                        <tr> 	
 							<td align="right" width="24%"><spring:message code="sirius.name"/> :</td>
							<td width="40%"> <input class="input-disabled" value="${partyBankAccount_add.party.fullName}" disabled="disabled" size="36"/></td>
 						</tr>
 						<tr>
...
<script type="text/javascript">
	$(function()
	{
		...
		$('.item-button-save').click(function()
		{
			...
			$.ajax({
				url:"<c:url value='/page/partybankaccountadd.htm'/>",
					...
					if(json)
					{
						if(json.status == 'OK')
						{
							...
							<c:if test='${empty redirectURL}'>
								window.location="<c:url value='/page/partypreedit.htm?id=${partyBankAccount_add.party.id}'/>";
							</c:if>

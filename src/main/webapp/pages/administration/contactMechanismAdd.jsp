	...
	<sesform:form id='addForm' name="addForm" method="post" modelAttribute="contactMechanism_add">
		<table>
			...
			<tr>
				...
				<td><form:select path="contactMechanismType">
			...
			<tr>
				...
				<td><form:radiobutton path="active" value="true" label="Active" /> <form:radiobutton path="active" value="false" label="Inactive" /></td>
			</tr>
			<tr>
				<td align="right"><spring:message code="sirius.default" /> :</td>
				<td><form:radiobutton path="def" value="true" label="Yes" /><form:radiobutton path="def" value="false" label="No" /></td>
			</tr>
			<tr>
...
<script type="text/javascript">
	...
	function validateForm() {
		...
		var contactMechanismType = $('select[name="contactMechanismType"]')
				.val();
	...
	function save() {
		$
				.ajax({
					...
					type : 'POST',
					dataType : 'json',
					beforeSend : beforeSend($dialog,
							'<spring:message code="notif.saving"/>'),
					success : function(json) {
						if (json) {
							if (json.status == 'OK') {
								...
								afterFail($dialog,
										'<spring:message code="notif.profailed"/> :<br/>'
												+ json.message);
						}
					}
				});

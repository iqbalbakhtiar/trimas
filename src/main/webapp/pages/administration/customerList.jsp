						...
						<tr>
							 <td class="tools">
							 	<c:if test='${access.edit}'>
									<c:choose>
									    <c:when test="${customer.partyFrom.base}">
									        <a class="item-button-edit" href="<c:url value='/page/customergrouppreedit.htm?id=${customer.id}'/>" title="<spring:message code='sirius.edit'/>">
									            <span><spring:message code="sirius.edit"/></span>
									        </a>
									    </c:when>
									    <c:otherwise>
									        <a class="item-button-edit" href="<c:url value='/page/customerpreedit.htm?id=${customer.id}'/>" title="<spring:message code='sirius.edit'/>">
									            <span><spring:message code="sirius.edit"/></span>
									        </a>
									    </c:otherwise>
									</c:choose>
								...
								<c:if test='${access.delete}'>
									<c:choose>
										<c:when test="${customer.partyFrom.base}">
											<a class="item-button-delete" href="javascript:showDialog('<c:url value='/page/customergroupdelete.htm?id=${customer.id}'/>');" title="<spring:message code='sirius.delete'/>"><span><spring:message code="sirius.delete"/></span></a>	
										</c:when>
										<c:otherwise>
											<a class="item-button-delete" href="javascript:showDialog('<c:url value='/page/customerdelete.htm?id=${customer.id}'/>');" title="<spring:message code='sirius.delete'/>"><span><spring:message code="sirius.delete"/></span></a>
										</c:otherwise>
									</c:choose>
								</c:if>
							</td>

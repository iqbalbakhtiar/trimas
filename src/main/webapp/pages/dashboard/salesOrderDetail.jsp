								...
								<div class="main-box">
									<div class="main_container">
										...
										<table width="100%" cellpadding="5" cellspacing="0" class="report-table tablesorter">
											<thead>
												<tr>
													<th width="30%" align="left" style="border-bottom: 1px solid black;border-top: 1px solid black;">Sales</th>
													<c:if test="${filter.personId!=0}">
											...
											<tbody>
												<c:forEach items='${reports}' var='report'>
													<tr>
														...
														<td align="left"><c:if test="${filter.personId==0}">
																<a href="javascript:filterByPerson(${report.salesPerson.id})"><c:out value='${report.salesPerson.firstName}' /></a>
															</c:if> <c:if test="${filter.personId!=0}">
																<c:out value='${report.salesPerson.firstName}' />
															</c:if></td>
														<c:if test="${filter.personId!=0}">
														...
														<td align="right"><fmt:formatNumber value='${report.totalAmount}' pattern="#,###.00" /></td>
												...
												<tr>
													<td colspan="${filter.personId==0?'5':'8'}" style="border-top: 1px solid black;">&nbsp;</td>
												</tr>
											</tbody>
										</table>
									</div>

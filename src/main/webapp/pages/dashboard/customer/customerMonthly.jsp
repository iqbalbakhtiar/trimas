...
<base href="<%=basePath%>">
	<html>
<head>
<title>Annual Sales (By Customer Monthly)</title>
		...
		<div id="se-navigator">
			<div class="area" dojoType="Container" id="quick_link_container">
				<table border="0" cellpadding="0" cellspacing="0" width="100%">
					<tr>
						<td width="60%">Dashboard > Annual Sales (By Customer Monthly)</td>
				...
				<div id="r13">
					<div id="r14">
						<div id="se-contents">
							<div class="area" dojoType="Container" id="quick_link_container">
								<h1 class="page-title">
									Annual Sales (By Customer Monthly)<br/>
								</h1>
								...
								<div class="main-box">
									<div class="main_container">
										<div class="report">
											<strong>Annual Sales (By Customer Monthly)</strong>
										</div>
										<div class="clears">&nbsp;</div>
										<center><img src="<c:url value='/charts/${filename}'/>.png"/></center>
										<table class="tablesorter report-table" cellpadding="0" cellspacing="0" border="0">
											<thead>
												<tr>
													...
													<th width="5%" align="center" style="border-bottom: 1px solid black; border-top: 1px solid black;" class="sorter-amount">JAN</th>
													<th width="5%" align="center" style="border-bottom: 1px solid black; border-top: 1px solid black;" class="sorter-amount">FEB</th>
													<th width="5%" align="center" style="border-bottom: 1px solid black; border-top: 1px solid black;" class="sorter-amount">MAR</th>
													<th width="5%" align="center" style="border-bottom: 1px solid black; border-top: 1px solid black;" class="sorter-amount">APR</th>
													<th width="5%" align="center" style="border-bottom: 1px solid black; border-top: 1px solid black;" class="sorter-amount">MAY</th>
													<th width="5%" align="center" style="border-bottom: 1px solid black; border-top: 1px solid black;" class="sorter-amount">JUN</th>
													<th width="5%" align="center" style="border-bottom: 1px solid black; border-top: 1px solid black;" class="sorter-amount">JUL</th>
													<th width="5%" align="center" style="border-bottom: 1px solid black; border-top: 1px solid black;" class="sorter-amount">AUG</th>
													<th width="5%" align="center" style="border-bottom: 1px solid black; border-top: 1px solid black;" class="sorter-amount">SEP</th>
													<th width="5%" align="center" style="border-bottom: 1px solid black; border-top: 1px solid black;" class="sorter-amount">OCT</th>
													<th width="5%" align="center" style="border-bottom: 1px solid black; border-top: 1px solid black;" class="sorter-amount">NOV</th>
													<th width="5%" align="center" style="border-bottom: 1px solid black; border-top: 1px solid black;" class="sorter-amount">DEC</th>
													<th width="5%" align="left" style="border-bottom: 1px solid black; border-top: 1px solid black;" class="sorter-amount">Total</th>
												</tr>
											</thead>
											<tbody>
												...
												<c:forEach items='${reports}' var='report'>
													<tr>
														...
														<td align="right"><fmt:formatNumber value='${report.january}' pattern="#,###.00"/></td>
														<td align="right"><fmt:formatNumber value='${report.february}'  pattern="#,###.00"/></td>
														<td align="right"><fmt:formatNumber value='${report.march}'  pattern="#,###.00"/></td>
														<td align="right"><fmt:formatNumber value='${report.april}'  pattern="#,###.00"/></td>
														<td align="right"><fmt:formatNumber value='${report.may}'  pattern="#,###.00"/></td>
														<td align="right"><fmt:formatNumber value='${report.june}'  pattern="#,###.00"/></td>
														<td align="right"><fmt:formatNumber value='${report.july}'  pattern="#,###.00"/></td>
														<td align="right"><fmt:formatNumber value='${report.august}'  pattern="#,###.00"/></td>
														<td align="right"><fmt:formatNumber value='${report.september}'  pattern="#,###.00"/></td>
														<td align="right"><fmt:formatNumber value='${report.october}'  pattern="#,###.00"/></td>
														<td align="right"><fmt:formatNumber value='${report.november}'  pattern="#,###.00"/></td>
														<td align="right"><fmt:formatNumber value='${report.december}'  pattern="#,###.00"/></td>
														<td align="right"><fmt:formatNumber value='${report.total}'  pattern="#,###.00"/></td>
														<c:set var="gtotal" value="${gtotal+report.total}" />
														<c:set var="gjan" value="${gjan+report.january}" />
														<c:set var="gmar" value="${gmar+report.march}" />
														<c:set var="gfeb" value="${gfeb+report.february}" />
														<c:set var="gapr" value="${gapr+report.april}" />
														<c:set var="gmay" value="${gmay+report.may}" />
														<c:set var="gjun" value="${gjun+report.june}" />
														<c:set var="gjul" value="${gjul+report.july}" />
														<c:set var="gaug" value="${gaug+report.august}" />
														<c:set var="gsep" value="${gsep+report.september}" />
														<c:set var="goct" value="${goct+report.october}" />
														<c:set var="gnov" value="${gnov+report.november}" />
														<c:set var="gdec" value="${gdec+report.december}" />
...
<script type="text/javascript">
	function showDetails(index,param){
		...
		$("#indexName").val(index);
		document.filterForm.action="<c:url value='/page/dashboardchartcustomermonthly.htm?page=2'/>";

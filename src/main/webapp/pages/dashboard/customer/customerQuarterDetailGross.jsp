...
<base href="<%=basePath%>">
	<html>
<head>
<title>Annual Gross Sales (By Customer Quarter)</title>
		...
		<div id="se-navigator">
			<div class="area" dojoType="Container" id="quick_link_container">
				<table border="0" cellpadding="0" cellspacing="0" width="100%">
					<tr>
						<td width="60%">Dashboard > Annual Gross Sales (By Customer Quarter)</td>
				...
				<div id="r13">
					<div id="r14">
						<div id="se-contents">
							<div class="area" dojoType="Container" id="quick_link_container">
								<h1 class="page-title">
									Annual Gross Sales (By Customer Quarter)<br/>
								</h1>
...
<script type="text/javascript">
	function showDetails(index,param){
		...
		$("#indexName").val(index);
		document.filterForm.action="<c:url value='/page/dashboardchartcustomerquartergross.htm?page=2'/>";

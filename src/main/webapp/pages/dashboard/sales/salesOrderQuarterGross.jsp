...
<base href="<%=basePath%>">
	<html>
<head>
<title>Annual Gross Sales (By Sales Quarter)</title>
		...
		<div id="se-navigator">
			<div class="area" dojoType="Container" id="quick_link_container">
				<table border="0" cellpadding="0" cellspacing="0" width="100%">
					<tr>
						<td width="60%">Dashboard > Annual Gross Sales (By Sales Quarter)</td>
				...
				<div id="r13">
					<div id="r14">
						<div id="se-contents">
							<div class="area" dojoType="Container" id="quick_link_container">
								<h1 class="page-title">
									Annual Gross Sales (By Sales Quarter)<br/>
								</h1>
								...
								<div class="toolbar">
									...
									<div style="float:right;">
										<a class="item-button-chart" href="<c:url value='/page/dashboardchartsoquarter.htm'/>"><span>Net Sales View</span></a>
										<a class="item-button-chart" href="<c:url value='/page/dashboardchartquartergross.htm'/>"><span>Gross Profit View</span></a>
										<a class="item-button-chart" href="<c:url value='/page/dashboardchartquarterqty.htm'/>"><span>Quantity Sold View</span></a>
									</div>
								</div>
											...
											<tbody>
												...
												<c:forEach items='${reports}' var='report'>
													...
													<tr>
														...
														<td align="right">
															<fmt:formatNumber value="${report.quarter1!=null?(report.quarter1-report.quarter1Cogs):0}" />
															<c:set var="t1" value="${t1+(report.quarter1-report.quarter1Cogs)}" />
														</td>
														<td align="right">
															<fmt:formatNumber value="${report.quarter2!=null?(report.quarter2-report.quarter2Cogs):0}" />
															<c:set var="t2" value="${t2+(report.quarter2-report.quarter2Cogs)}" />
														</td>
														<td align="right">
															<fmt:formatNumber value="${report.quarter3!=null?(report.quarter3-report.quarter3Cogs):0}" />
															<c:set var="t3" value="${t3+(report.quarter3-report.quarter3Cogs)}" />
														</td>
														<td align="right">
															<fmt:formatNumber value="${report.quarter4!=null?(report.quarter4-report.quarter4Cogs):0}" />
															<c:set var="t4" value="${t4+(report.quarter4-report.quarter4Cogs)}" />
														</td>
														<c:set var="total" value="${(report.quarter1+report.quarter2+report.quarter3+report.quarter4)-(report.quarter4Cogs+report.quarter3Cogs+report.quarter2Cogs+report.quarter1Cogs)}" />
...
<script type="text/javascript">
	function showDetails(index,param){
		...
		$("#indexName").val(index);
		document.filterForm.action="<c:url value='/page/dashboardchartsoquartergross.htm?page=2'/>";

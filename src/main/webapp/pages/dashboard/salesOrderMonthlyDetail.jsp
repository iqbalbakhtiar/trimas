...
<base href="<%=basePath%>">
	<html>
<head>
<title>Annual Sales (By Monthly)</title>
		...
		<div id="se-navigator">
			<div class="area" dojoType="Container" id="quick_link_container">
				<table border="0" cellpadding="0" cellspacing="0" width="100%">
					<tr>
						<td width="60%">Dashboard > Annual Sales (By Monthly)</td>
						...
						<div id="se-contents">
							<div class="area" dojoType="Container" id="quick_link_container">
								...
								<div class="toolbar">
									...
									<div style="float:right;">
										<a class="item-button-chart" href="<c:url value='/page/dashboardchartsomonthly.htm'/>"><span>Net Sales View</span></a>
										<a class="item-button-chart" href="<c:url value='/page/dashboardchartmonthlygross.htm'/>"><span>Gross Profit View</span></a>
										<a class="item-button-chart" href="<c:url value='/page/dashboardchartmonthlqty.htm'/>"><span>Quantity Sold View</span></a>
									</div>
								</div>
							...
							<div class="main-box">
								<div class="main_container">
									<div class="report">
										<strong>Annual Sales (By Monthly)</strong>
									</div>
...
<script type="text/javascript">
	function showDetails(index,param){
		...
		$("#indexName").val(index);
		document.filterForm.action="<c:url value='/page/dashboardchartsomonthly.htm?page=2'/>";

...
<head>
  ...
  <%@ include file="/filter/procurement/purchaseOrderFilter.jsp"%>
</head>
<body>
          ...
          <div id="se-contents">
                  ...
                  <td width="35%" height="30" align="left" valign="middle">
                    <div class="toolbar-clean">
                      <c:if test='${access.add}'>
                        <a class="item-button-new" href="<c:url value='/page/purchaseorderpreadd.htm' />"><span><spring:message code="purchaseorder.new"/></span></a>
                      </c:if>
            ...
            <table class="table-list" cellspacing="0" cellpadding="0" width="100%">
              ...
              <c:forEach items="${purchaseOrders}" var="purchaseOrder">
                <tr>
                  <td class="tools">
                    <a class="item-button-edit" href="<c:url value='/page/purchaseorderpreedit.htm?id=${purchaseOrder.id}'/>" title="<spring:message code='sirius.edit'/>"><span><spring:message code="sirius.edit"/></span></a>
                    <c:if test='${access.delete and purchaseOrder.deleteable}'>
                    	<a class="item-button-delete" href="javascript:showDialog('<c:url value='/page/purchaseorderdelete.htm?id=${purchaseOrder.id}'/>');" title="<spring:message code='sirius.delete'/>"><span><spring:message code='sirius.delete'/></span></a>
                   	</c:if>
                  </td>

...
<div class="toolbar">
  ...
  <a class="item-button-export-xls" download="purchaseorder.xls" href="#" onclick="return ExcellentExport.excel(this, 'size', 'Purchase Order');"><span>Export</span></a>
</div>
...
<%--                  <c:out value='${purchase_edit.requisition.supplierNumber}'/>--%>
          ...
          <td colspan="6">
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
              ...
              <tr>
                ...
                <th rowspan="2" width="10%" align="center" class="border-right border-top border-bottom">Harga(${purchase_edit.currency.symbol})</th>
                <th rowspan="2" width="10%" align="center" class="border-right border-top border-bottom">Total(${purchase_edit.currency.symbol})</th>
  ...
  <%@include file="purchaseOrderExcel.jsp"%>
</div>

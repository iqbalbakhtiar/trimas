			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
						...
						<div class="toolbar">
							<a class="item-button-list" href="<c:url value='/page/uompreedit.htm?id=${unit_of_measure_factor_add.from.id}'/>"><span><spring:message code='sirius.list'/></span></a>
			...
			$.ajax({
				...
				success : function(json) {
					if(json)
					{
						...
						{
							$dialog.dialog('close');
							window.location="<c:url value='/page/uompreedit.htm?id=${unit_of_measure_factor_add.from.id}'/>";
						}
						else

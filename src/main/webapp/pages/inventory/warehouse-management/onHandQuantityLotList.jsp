...
<%@ include file="/filter/inventory/onHandQuantityLotFilter.jsp"%>
		...
		<tr>
			<td class="tools">
				<c:if test="${access.add}">
					<a class="item-button-edit" href="<c:url value='/page/onhandquantityeditlotview.htm?product=${on.product.id}&lotCode=${on.lot.code}'/>" title="Edit"><span><spring:message code="sirius.edit"/></span></a>
				</c:if>
			</td>

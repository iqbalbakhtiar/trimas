			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
                        ...
                        <div class="main-box">			
							<sesform:form id="addForm" name="addForm" method="post" modelAttribute='paymentType_form'>
											...
											<td>
												<form:select id="referenceType" path='referenceType'>
													<c:forEach items="${referenceTypes}" var="refType">
														<form:option value='${refType}'><spring:message code="paymentreferencetype.${refType.messageName}"/></form:option>
													</c:forEach>
												</form:select>
											</td>
			 							</tr>
...
<script type="text/javascript" language="javascript">
	$(function(){
		...
		$('.item-button-save').click(function(e){
			...
			$.ajax({
				url:"<c:url value='/page/paymentmanualtypeadd.htm'/>",

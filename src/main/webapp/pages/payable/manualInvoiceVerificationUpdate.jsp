...
<div class="toolbar">
	...
	<a class="item-button-print"  href="<c:url value='/page/manualinvoiceverificationprint.htm?id=${verification_edit.id}'/>"><span><spring:message code="sirius.print"/></span></a>
</div>
        ...
        <table class="table-list" id="lineItemTable" cellspacing="0" cellpadding="0" align="center"  style="width:100%;">
            ...
            <c:forEach items="${verification_edit.items}" var="item" varStatus="idx">
                <tr>
                    ...
                    <td><input value="<fmt:formatNumber value='${item.discount}' pattern=',##0.00'/>" size="12" class="number-disabled" disabled/></td>
...
<script type="text/javascript">
    ...
    function save() {
        $.ajax({
            url:"<c:url value='/page/manualinvoiceverificationedit.htm'/>",

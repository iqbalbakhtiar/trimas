                    ...
                    <div id="se-contents">
                                ...
                                <tr>
                                    <td width="30%" height="30" align="left" valign="middle">
                                        <div class="toolbar-clean">
                                            <a class="item-button-new" href="<c:url value='/page/paymentpreadd.htm'/>"><span><spring:message code="payment.new"/></span></a>
                        ...
                        <table class="table-list" cellspacing="0" cellpadding="0" width="100%">
                            ...
                            <c:forEach items="${payments}" var="payment">
                                <tr>
                                    <td class="tools">
                                        <a class="item-button-edit" href="<c:url value='/page/paymentpreedit.htm?id=${payment.id}'/>"  title="Edit"><span>Edit</span></a>
                                    </td>
                                    <td nowrap="nowrap"><c:out value="${payment.code}" /></td>
                                    <td nowrap="nowrap"><fmt:formatDate value='${payment.date}' pattern='dd-MM-yyyy'/></td>
                                    <td><c:out value='${payment.supplier.fullName}'/></td>
                                    <td class="break-over">${payment.note}</td>
                                </tr>
                            </c:forEach>

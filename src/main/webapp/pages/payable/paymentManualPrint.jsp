			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
						<div class="area" dojoType="Container" id="quick_link_container">			
					  		<div class="toolbar">
								<a class="item-button-back" href="<c:url value='/page/paymentmanualpreedit.htm?id=${paymentManual_edit.id}'/>"><span>Back</span></a>
						...
						<div class="main-box">
							<div class="main_container">
								...
								<tr>
									<td><strong>BUKTI KAS KELUAR</strong></td>
								</tr>
								<tr>
									<td class="border-top border-bottom border-left border-right" style="padding: 0;">
										...
										<tr style="height: 30px;">
											...
											<td colspan="3" class="border-bottom border-right">${paymentManual_edit.supplier.fullName}</td>
										...
										<tr style="height: 220px;">
											...
											<td class="border-bottom border-right" colspan="4" valign="middle">
												<table border="0" width="100%" cellpadding="3" cellspacing="0">
												<c:if test="${not empty paymentManual_edit.note}">
												<tr>
													<td width="5%">&nbsp;</td>
													<td width="95%" style="padding-left: 10px;">${paymentManual_edit.note}</td>
												</tr>
												<tr style="height: 50px;">
													<td colspan="2">&nbsp;</td>
												</tr>
												</c:if>
												<c:if test="${paymentManual_edit.paymentInformation.paymentMethodType ne 'CASH'}">
													<tr>
														<td width="5%" nowrap="nowrap">No. Acc</td>
														<td width="95%" style="text-transform: uppercase;">: <strong>${paymentManual_edit.paymentInformation.bankAccountTo.bankName}, ${paymentManual_edit.paymentInformation.bankAccountTo.accountNo}</strong></td>
													</tr>
													<tr>
														<td>A/N</td>
														<td style="text-transform: uppercase;">: <strong>${paymentManual_edit.paymentInformation.bankAccountTo.accountName}</strong></td>
													</tr>
												</c:if>
												</table>
											</td>
											<td class="border-bottom" valign="middle" align="center"><fmt:formatNumber value="${paymentManual_edit.paymentInformation.amount}" pattern=",##0.00"/></td>
										</tr>
										<tr>
											<td class="border-bottom border-right">Terbilang</td>
											<td class="border-bottom border-right" colspan="4"><c:out value='${saidId}'/> <c:out value="${paymentManual_edit.currency.alias}"/></td>
											<td class="border-bottom" align="center"><strong><c:out value="${paymentManual_edit.currency.symbol}"/> <fmt:formatNumber value="${paymentManual_edit.paymentInformation.amount}" pattern=",##0.00"/></strong></td>
										</tr>

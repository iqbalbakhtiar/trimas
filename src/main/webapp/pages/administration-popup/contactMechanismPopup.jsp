...
<html>
	<head>
	<title>Contact Mechanism >> Popup</title>
			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
						...
						<c:forEach items="${contacts}" var="com">
						<tr>
					  		<td class="tools">
					  			<a class="item-button-add-row" href="javascript:setclient('${com.id}','${com.contact}')"  title="Edit"><span>Edit</span></a>
					  		</td>
							<td>${com.contact}</td>
                            <td>${com.note}</td>
					  		</tr>

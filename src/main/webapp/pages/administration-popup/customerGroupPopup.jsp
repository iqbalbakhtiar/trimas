			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
						...
						<c:forEach items="${customerGroups}" var="com">
						<tr>
					  		<td class="tools">
					  			<a class="item-button-add-row" href="javascript:setclient('${com.partyFrom.id}','${com.partyFrom.code}','${com.partyFrom.fullName}')"  title="Edit"><span>Edit</span></a>
					  		</td>
							<td nowrap="nowrap"><c:out value='${com.partyFrom.code}'/></td> 
							<td><c:out value='${com.partyFrom.fullName}'/></td>
					  		</tr>
						</c:forEach>

			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
						...
						<tr>
					  		<td class="tools">
					  			<a class="item-button-add-row" href="javascript:setclient('${receipt.id}','${receipt.name}','<spring:message code="paymentreferencetype.${receipt.referenceType.messageName}"/>')" title="Edit"><span>Edit</span></a>
					  		</td>
